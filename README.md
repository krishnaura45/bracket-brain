# 🏀bracket-brain
> Predicting NCAA basketball tournament outcomes using ML models and promoting sports analytics.
...
- **Exploratory Data Analysis (EDA)**:
  - Explored tournament structure, team seeding, and regional splits.
